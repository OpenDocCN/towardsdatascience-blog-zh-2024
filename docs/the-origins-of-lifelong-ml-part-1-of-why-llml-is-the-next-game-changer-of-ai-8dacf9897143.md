...
在 Q 学习中，我们将学习π*的问题简化为学习π*的 Q*值的问题。显然，我们希望选择 Q 值最大的动作。
...
如果我们重复这个解释和分析过程，我们可以替代一些朴素 Q 学习中需要通过现实世界探索代理环境的部分需求！而且我们使用得越多，它就变得越有效，因为（抽象地说）它可以从更多的知识中获取信息，增加这些知识与当前任务相关的可能性。
