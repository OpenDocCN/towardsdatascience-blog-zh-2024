...
> 原文：[`towardsdatascience.com/images-that-sound-creating-stunning-audiovisual-art-with-ai-024a317c7472?source=collection_archive---------2-----------------------#2024-08-05`](https://towardsdatascience.com/images-that-sound-creating-stunning-audiovisual-art-with-ai-024a317c7472?source=collection_archive---------2-----------------------#2024-08-05)

[](https://medium.com/@maxhilsdorf?source=post_page---byline--024a317c7472--------------------------------)![Max Hilsdorf](https://medium.com/@maxhilsdorf?source=post_page---byline--024a317c7472--------------------------------)[](https://towardsdatascience.com/?source=post_page---byline--024a317c7472--------------------------------)![Towards Data Science](https://towardsdatascience.com/?source=post_page---byline--024a317c7472--------------------------------) [Max Hilsdorf](https://medium.com/@maxhilsdorf?source=post_page---byline--024a317c7472--------------------------------)

·发表于 [Towards Data Science](https://towardsdatascience.com/?source=post_page---byline--024a317c7472--------------------------------) ·8 分钟阅读·2024 年 8 月 5 日
...
![](img/8d9d61768e52f3121749a0b167aa5d7a.png)

声音图像：在单一画布上创作图像与声音 — [`arxiv.org/pdf/2405.12221`](https://arxiv.org/pdf/2405.12221)
...
2024 年 5 月，来自密歇根大学的三位研究人员发布了一篇名为[《声音图像：在单一画布上创作图像与声音》](https://arxiv.org/pdf/2405.12221)的论文。
...
1.  为什么这篇论文挑战了我们对 AI 可以做什么以及应该做什么的理解
...
![](img/82f1b8103f8259b0ecbcc20db1943364.png)
...
![](img/355f6d2080168bcfaf7da17c3e681dc5.png)
...
![](img/484825ab7e29159658a52709ee2073f1.png)
...
AI 通常被定义为模仿人类智能的计算机系统（例如[IMB](https://www.ibm.com/topics/artificial-intelligence)、[TechTarget](https://www.techtarget.com/searchenterpriseai/definition/AI-Artificial-Intelligence)、[Coursera](https://www.coursera.org/articles/what-is-artificial-intelligence)）。这种定义在销售预测、图像分类和文本生成等 AI 模型中效果良好。然而，它带来了一个固有的限制，即计算机系统只有在执行人类历史上已解决的任务时，才能被视为 AI。
...
![](img/b1bfc6e562832fcce2db5d3d4d265c02.png)
...
在[Mixmag 的文章](https://mixmag.net/feature/spectrogram-art-music-aphex-twin)中，Becky Buckle 探讨了“艺术家如何将视觉元素隐藏在音乐的波形中”的历史。一个令人印象深刻的人类频谱图艺术的例子是英国音乐人 Aphex Twin 的歌曲《∆Mᵢ⁻¹=−α ∑ Dᵢ[η][ ∑ Fjᵢ[η−1]+Fextᵢ [η⁻¹]]》。

![](img/2bc35c71f72ca3af20f06a034d3d8a92.png)

Aphex Twin 的《∆Mᵢ⁻¹=−α ∑ Dᵢ[η][ ∑ Fjᵢ[η−1]+Fextᵢ [η⁻¹]]》中外星人面孔的截图。[视频链接。](https://www.youtube.com/watch?v=wSYAZnQmffg&ab_channel=Maxdamantus)

另一个例子是加拿大音乐人 Venetian Snares 的专辑《Songs about my Cats》中的曲目《Look》。

![](img/3b722e0f35f03aafa55d6425651f6ca1.png)

Venetian Snares 的《Look》中的猫咪图像截图。[视频链接](https://www.youtube.com/watch?v=BHup81lEjqo&ab_channel=monotoniac)。
...
在我与众多谈论人工智能的人交谈后，艺术家们往往对人工智能持最为消极的态度。这一点得到了最近德国 GEMA 的[研究](https://www.gema.de/en/news/ai-study)的支持，研究显示，超过 60%的音乐家“认为人工智能的使用风险大于其潜在机会”，而只有 11%的人“认为机会大于风险”。
...
![](img/2a605af850dc0b4198e6336a1c871ce0.png)
...
AI 有潜力通过将单声道混音转换为立体声混音来增强旧录音。虽然有经典的算法方法来实现这一点，但 AI 承诺使人工立体声混音听起来越来越真实。[阅读更多](https://www.alango.com/technologies-mono2stereo.php) 和 [阅读更多](https://arxiv.org/pdf/2306.14647)。
...
+   **AI 音乐源分离：它是如何工作的，为什么这么难**：[`medium.com/towards-data-science/ai-music-source-separation-how-it-works-and-why-it-is-so-hard-187852e54752`](https://medium.com/towards-data-science/ai-music-source-separation-how-it-works-and-why-it-is-so-hard-187852e54752)
