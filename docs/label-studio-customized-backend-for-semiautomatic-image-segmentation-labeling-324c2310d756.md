...
到目前为止，我们已经成功启动了所有3个容器，你可以再次检查确认。
...
![](../Images/322a3e2f68d88aa1a2334299bdecfd7e.png)
...
很可能你不希望你的存储桶是公开的，那么Label Studio需要认证才能访问这些图片。点击**创建服务账户**，并授予**存储管理员**角色，这样我们就可以读写GCS存储桶。你应该能够在存储桶的权限列表中看到这个服务账户。
