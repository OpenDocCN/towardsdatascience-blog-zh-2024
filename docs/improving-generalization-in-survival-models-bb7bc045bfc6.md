...
![](../Images/74122d67e23cd850b485539e7e9f5dd3.png)
...
然后我们再次训练模型，并在之前相同的测试集上评估它。我们现在看到的协调指数大约为0.80。虽然没有之前的+0.90，但它确实比随机机会水平0.5有所提升。就我们对员工分类的兴趣而言，尽管仍远未达到之前的+0.9 F1分数，但与之前的方法相比，我们确实看到了一些提高，尤其是在少数类别上。
