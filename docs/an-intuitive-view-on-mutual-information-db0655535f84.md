...
> 原文：[`towardsdatascience.com/an-intuitive-view-on-mutual-information-db0655535f84?source=collection_archive---------6-----------------------#2024-03-13`](https://towardsdatascience.com/an-intuitive-view-on-mutual-information-db0655535f84?source=collection_archive---------6-----------------------#2024-03-13)

## 普通人如何理解关联概念

[](https://medium.com/@markchangg?source=post_page---byline--db0655535f84--------------------------------)![Mark Chang](https://medium.com/@markchangg?source=post_page---byline--db0655535f84--------------------------------)[](https://towardsdatascience.com/?source=post_page---byline--db0655535f84--------------------------------)![Towards Data Science](https://towardsdatascience.com/?source=post_page---byline--db0655535f84--------------------------------) [Mark Chang](https://medium.com/@markchangg?source=post_page---byline--db0655535f84--------------------------------)

·发表于[Towards Data Science](https://towardsdatascience.com/?source=post_page---byline--db0655535f84--------------------------------) ·8 分钟阅读·2024 年 3 月 13 日

--

![](img/119a293dadb7e3a97d7b8666de767d74.png)
...
![](img/78bbaebed9d998ae8de882ead9c34c67.png)
...
![](img/23262ac9ac78fbd879c736b941f5b590.png)
...
![](img/a4f6e7a5ead25c261663a5081fbb6a6f.png)

离散/二进制观察携伞与天气

假设我们有 Bob 在这个确切顺序中的 5 天观察数据：

![](img/a5f8f1a57846c491c3a4f19ac00c51ad.png)

在 5 天内对携伞与天气的离散/二进制观察

## **个体/边际概率**

![](img/383c1c8c07fb4779e277865282fe9c24.png)

这些仅仅是观察特定*x*或*y*在其各自的*X*和*Y*值集合中的简单概率。

以*x = 1*为例：概率简单为*0.4*（Bob 在假期的 5 天中有 2 天带了伞）。

## **联合概率**

![](img/cc6114a1cdc620ee8e98e97fbdbe1177.png)

这是从联合概率（*X, Y*）中观察特定*x*和*y*的概率。联合概率（*X, Y*）仅仅是成对观察的集合。我们根据它们的索引将它们配对。

在我们的案例中，我们根据它们发生的具体日期将 Bob 的观察配对起来。

![](img/a881e1dbacfa805bf74e041ddc5a140b.png)
...
![](img/5be386e3384c40df59a7e23635daadee.png)

我们可以计算这两个概率的比值，从而给我们一个关于**“巧合程度”**的线索。

在分母中，我们取特定*x*和特定*y 发生的个体概率的乘积。我们为什么要这么做？
...
+   第二次抛掷 [*p(y*)]：得到正面的几率仍然是 50%，因为结果**独立**于第一次抛掷发生的事情。

+   上面这 2 次抛掷构成了你的个体概率

+   因此，**理论上**在 2 次独立抛掷中得到 2 个正面的概率是 *0.5* * 0.5* = 0.25*（ *p(x).p(y)*）

![](img/8499b8db31a00ac5b3cb3b6f52277fbd.png)
...
为了将这种定性感觉转化为数字，概率的比值现在是惊人的*3.6 (0.9 / 0.25)*，也就是说，比我们预期的要频繁 3.6 倍。
...
![](img/25e9be68a91424b51e5245c580c56a0e.png)
...
![](img/a273e4b9b4ea16ede7fbcbbd37c09dbd.png)
...
![](img/e40d4d458dde7c2f139bf9b2e10df7b9.png)

将概率比率转换为它们的对数形式后，我们现在可以简单地按照上面描述的使用**对数求和**来计算期望值。
...
![](img/c07fbe0d1451d05fa071d7d2555cf854.png)
...
![](img/70abc9232eefbc36d9c44dcb55bc713f.png)

计算它们的互信息分数、Spearman 等级相关系数，并绘制图表，我们得到如下结果：

![](img/4c73cfb29d55e9f31e7b62c88a438361.png)
...
![](img/0f8a77486dbd30f736b568c22677154e.png)
...
![](img/792fe745d9888281b96376019e26e4a4.png)
