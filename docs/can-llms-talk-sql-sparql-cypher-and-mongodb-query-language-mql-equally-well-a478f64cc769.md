# LLM 在生成 SQL、SPARQL、Cypher 或 MongoDB 查询时表现更好吗？
...
图 3\. SM3-Text-to-Query 基准构建。将合成患者数据生成与四种数据库的 ETL 过程结合起来，使得可以创建任意大的合成数据集。(*图像由作者提供*)
...
![](img/70eb4bf3f675b398aa8a2c6d27c37e8e.png)
