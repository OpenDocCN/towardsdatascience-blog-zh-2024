...
也许，但还有很多工作需要完成才能到达那个点。任何构建代理的开发者不仅需要选择基础架构——选择使用哪个模型、使用场景和架构——还需要选择利用哪个框架。你是选择长期存在的 LangGraph，还是选择新兴的 LlamaIndex 工作流？或者你选择传统方式，自己编写整个代码？
...
![](img/86bb92ce7e47d92f16d5fb9bdcadc985.png)
