...
> 原文：[`towardsdatascience.com/demo-ai-products-like-a-pro-785a2d9f2d63?source=collection_archive---------7-----------------------#2024-05-07`](https://towardsdatascience.com/demo-ai-products-like-a-pro-785a2d9f2d63?source=collection_archive---------7-----------------------#2024-05-07)

## 一份关于如何使用 Gradio 向专家和非技术观众展示产品价值的专家指南简介。

[](https://medium.com/@josephgeorgelewis2000?source=post_page---byline--785a2d9f2d63--------------------------------)![Joseph George Lewis](https://medium.com/@josephgeorgelewis2000?source=post_page---byline--785a2d9f2d63--------------------------------)[](https://towardsdatascience.com/?source=post_page---byline--785a2d9f2d63--------------------------------)![Towards Data Science](https://towardsdatascience.com/?source=post_page---byline--785a2d9f2d63--------------------------------) [Joseph George Lewis](https://medium.com/@josephgeorgelewis2000?source=post_page---byline--785a2d9f2d63--------------------------------)

·发布于 [Towards Data Science](https://towardsdatascience.com/?source=post_page---byline--785a2d9f2d63--------------------------------) ·15 分钟阅读·2024 年 5 月 7 日

--

![](img/9660be088f4c71b28a709809fc9ddc34.png)
...
![](img/f978c0de3422eea0c51b1308d0284395.png)
...
![](img/29a50a435e096a72a026dd978ab32828.png)
...
![](img/8a5fed64fc3219ad8d38670010e3dfac.png)
...
![](img/7e59515adde18648612aaddc49612081.png)
...
![](img/b8baf45c751ee03c3bcb95dcb66f10b8.png)
...
![](img/2132eea144bcbfca0ae1ce07e99f7225.png)![](img/10c685bb515e7a68a427dcfb73809bbf.png)
...
![](img/a0c4e5fd9735cafd05a38e91a11fe0a9.png)
...
这次我们不会使用任何新的东西。相反，我们将展示*Markdown()*组件的强大功能。你可能已经注意到我们已经使用了一些 Markdown。对于那些熟悉的人来说，Markdown 可以帮助以文本形式表达各种信息。下面的代码包含了一些想法，但在你的演示中，发挥创意，看看你能将 Markdown 在 Gradio 中应用到多远：

![](img/194507b2071a3fd7cf000686584d7480.png)

图片来源：作者提供

完成的演示如下。欢迎在评论中告诉我你的想法！

![](img/bb4a4b5f04dff429b7705cb6a06e8863.png)![](img/2f07696ad3cd718c3ffd703ccbf65ebc.png)![](img/bc04001d4371fc82f9de7772d42329ce.png)
...
![](img/3ac10b3136b8000af1cd05ac8407dcd2.png)
...
+   StreamLit 附加组件，StreamLit UI 组件的扩展：[`extras.streamlit.app/`](https://extras.streamlit.app/)

+   超棒的 R Shiny，Shiny 的附加反应式/UI/主题组件：[`github.com/nanxstats/awesome-shiny-extensions`](https://github.com/nanxstats/awesome-shiny-extensions)
...
[1] Gradio 文档。[`www.gradio.app/`](https://www.gradio.app/)

[2] 用户引导产品演示。[`userpilot.com/blog/product-demos/`](https://userpilot.com/blog/product-demos/)

[3] 聪明汉斯维基百科。[`en.wikipedia.org/wiki/Clever_Hans`](https://en.wikipedia.org/wiki/Clever_Hans)
